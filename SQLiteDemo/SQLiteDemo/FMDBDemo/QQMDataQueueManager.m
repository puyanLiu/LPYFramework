...
#import "QQMDataQueueManager.h"
#import "FMDBPropertyMappingDelegate.h"
#import <objc/runtime.h>

@implementation QQMDataQueueManager
...
- (NSArray *)executeQuery:(NSString *)sql withArgumentInArray:(id)param modelClass:(Class)modelClass handle:(void(^)(id model, FMResultSet *rs))handle
{
    ...
    [self inDatabase:^(FMDatabase *db) {
        ...
        while ([rs next]) {
            ...
            if (!mapping && [model conformsToProtocol:@protocol(FMDBPropertyMappingDelegate)]) {
