/*
* @Author: liupuyan
* @Date:   2017-01-11 16:06:10
* @Last Modified by:   liupuyan
* @Last Modified time: 2017-01-11 17:42:46
*/
...
PieChart.prototype = {
	...
	playAnimate: function() {
		...
		if(this.animageIndex == 0) {
			this.group.getChildren().each(function(value, index){
				value.angle(0);
			});
			this.txtGroup.getChildren().each(function(value,index){
				value.hide();
			});
		}
