...
#define LPYRGBA(r,g,b,a) [UIColor colorWithRed:r/255.0f green:g/255.0f blue:b/255.0f alpha:a]
...
// 解锁背景色
#define CircleViewBackgroundColor LPYRGBA(13,52,89,1)

// 普通状态下外空心圆颜色
#define CircleStateNormalOutsideColor LPYRGBA(241,241,241,1)

// 选中状态下外空心圆颜色
#define CircleStateSelectedOutsideColor LPYRGBA(34,178,246,1)

// 错误状态下外空心圆颜色
#define CircleStateErrorOutsideColor LPYRGBA(254,82,92,1)

// 普通状态下内实心圆颜色
#define CircleStateNormalInsideColor [UIColor clearColor]

// 选中状态下内实心圆颜色
#define CircleStateSelectedInsideColor LPYRGBA(34,178,246,1)

// 错误状态内实心圆颜色
#define CircleStateErrorInsideColor LPYRGBA(254,82,92,1)

// 普通状态下三角形颜色
#define CircleStateNormalTrangleColor [UIColor clearColor]

// 选中状态下三角形颜色
#define CircleStateSelectedTrangleColor LPYRGBA(34,178,246,1)

// 错误状态三角形颜色
#define CircleStateErrorTrangleColor LPYRGBA(254,82,92,1)

// 三角形边长
#define kTrangleLength 10.0f

// 普通时连线颜色
#define CircleConnectLineNormalColor LPYRGBA(34,178,246,1)

// 错误时连线颜色
#define CircleConnectLineErrorColor LPYRGBA(254,82,92,1)
...
// 普通状态下文字提示的颜色
#define textColorNormalState LPYRGBA(241,241,241,1)

// 警告状态下文字提示的颜色
#define textColorWarningState LPYRGBA(254,82,92,1)
...
@interface LPYCircleViewConst : NSObject
// 偏好设置：存字符串（手势密码）
