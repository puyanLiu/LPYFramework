...
@interface TestViewController () <QQMPlaceHolderViewDelegate, QQMTableViewPlaceHolderDelegate>
...
- (UIView *)weChatStylePlaceHolder {
    QQMPlaceHolderView *weChatStylePlaceHolder = [[QQMPlaceHolderView alloc] initWithFrame:self.tableView.frame];
