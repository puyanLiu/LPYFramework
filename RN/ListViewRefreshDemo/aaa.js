      ...
      let jsxarr = [];
        ...
        if (this.props.indicatorImg.url) {
          ...
          if (this.state.prLoading) {
            ...
            jsxarr.push(<Animated.View><Image source={loadingImage}>
              <Animated.View style={{borderColor: 'yellow', borderWidth: 1, height:20, transform: [{rotate: '180deg'}]}}></Animated.View>
            </Image></Animated.View>);
          } else {
            jsxarr.push(null);
          }
